        ...
        <div className="space-y-16 md:space-y-24">
          <div className="transition duration-500 ease-in-out transform scale-100 translate-x-0 translate-y-0 opacity-100">
            <div className="space-y-5 md:text-center">
              ...
              <h1 className="mt-4 bg-gradient-to-r from-[#1D976C] to-[#38ef7d] bg-clip-text text-3xl font-medium text-transparent text-center">
          ...
          <div className="grid grid-cols-1 grid-rows-2 gap-8 text-lg md:grid-cols-2 lg:grid-cols-3">
            ...
            <div className="flex shadow-md hover:shadow-green flex-col justify-between p-5 transition duration-400 bg-white bg-opacity-20 rounded-xl card-hover group space-y-5">
              <FontAwesomeIcon icon={faUsers} className="text-[#322e37] bg-gradient-to-g from-[#5b585f] to-[#2d2a33] h-10 w-10 rounded-full border p-2 transition duration-400 group-hover:border-[#00e4ff] group-hover:shadow-[#00e4ff] group-hover:shadow-sm" />
            ...
            <div className="flex shadow-md hover:shadow-green flex-col justify-between p-5 transition duration-400 bg-white bg-opacity-20 rounded-xl card-hover group space-y-5">
              <FontAwesomeIcon icon={faChalkboardTeacher} className="text-[#322e37] bg-gradient-to-g from-[#5b585f] to-[#2d2a33] h-10 w-10 rounded-full border p-2 transition duration-400 group-hover:border-[#00e4ff] group-hover:shadow-[#00e4ff] group-hover:shadow-sm" />
              <h3 className="text-xl font-semibold text-gray-800">
            ...
            <div className="flex shadow-md hover:shadow-green flex-col justify-between p-5 transition duration-400 bg-white bg-opacity-20 rounded-xl card-hover group space-y-5">
              <FontAwesomeIcon icon={faTools} className="text-[#322e37] bg-gradient-to-g from-[#5b585f] to-[#2d2a33] h-10 w-10 rounded-full border p-2 transition duration-400 group-hover:border-[#00e4ff] group-hover:shadow-[#00e4ff] group-hover:shadow-sm" />
              <h3 className="text-xl font-semibold text-gray-800">
                QUALITY EQUIPMENT
              </h3>
              <p className="text-gray-700">
            ...
            <div className="flex shadow-md hover:shadow-green flex-col justify-between p-5 transition duration-400 bg-white bg-opacity-20 rounded-xl card-hover group space-y-5">
              <FontAwesomeIcon icon={faHandsHelping} className="text-[#322e37] bg-gradient-to-g from-[#5b585f] to-[#2d2a33] h-10 w-10 rounded-full border p-2 transition duration-400 group-hover:border-[#00e4ff] group-hover:shadow-[#00e4ff] group-hover:shadow-sm" />
              <h3 className="text-xl font-semibold text-gray-800">
            ...
            <div className="flex shadow-md hover:shadow-green flex-col justify-between p-5 transition duration-400 bg-white bg-opacity-20 rounded-xl card-hover group space-y-5">
              <FontAwesomeIcon icon={faRobot} className="text-[#322e37] bg-gradient-to-g from-[#5b585f] to-[#2d2a33] h-10 w-10 rounded-full border p-2 transition duration-400 group-hover:border-[#00e4ff] group-hover:shadow-[#00e4ff] group-hover:shadow-sm" />
              <h3 className="text-xl font-semibold text-gray-800">
                Efficent Labs
              </h3>
              <p className="text-gray-700">
